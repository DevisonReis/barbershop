...
$pluginUpdated = ($trustindex_pm_google->get_plugin_current_version() <= "10.9.1");
...
<a href="?page=<?php echo sanitize_text_field($_GET['page']); ?>&tab=advanced&notification=review-download-available&action=hide"><?php echo TrustindexPlugin_google::___('Disable'); ?></a>
<?php else: ?>
<a href="?page=<?php echo sanitize_text_field($_GET['page']); ?>&tab=advanced&notification=review-download-available&action=unhide"><?php echo TrustindexPlugin_google::___('Enable'); ?></a>
<?php endif; ?>
</li>
<?php /*
<li>
...
<input type="text" data-type="review-download-available" class="form-control" value="<?php echo $trustindex_pm_google->getNotificationParam('review-download-available', 'email', get_option('admin_email')); ?>" />
</div>
...
echo TrustindexPlugin_google::___('Notification') .': '. ($isNotificationActive ? $yesIcon : $noIcon); ?>
<?php if ($isNotificationActive): ?>
<a href="?page=<?php echo sanitize_text_field($_GET['page']); ?>&tab=advanced&notification=review-download-finished&action=hide"><?php echo TrustindexPlugin_google::___('Disable'); ?></a>
<?php else: ?>
<a href="?page=<?php echo sanitize_text_field($_GET['page']); ?>&tab=advanced&notification=review-download-finished&action=unhide"><?php echo TrustindexPlugin_google::___('Enable'); ?></a>
<?php endif; ?>
</li>
<li>
<div class="ti-notification-email">
...
<a href="<?php echo wp_nonce_url('?page='. sanitize_text_field($_GET['page']) .'&tab=advanced&auto_update', 'ti-auto-update'); ?>"><?php echo TrustindexPlugin_google::___("Enable"); ?></a>
